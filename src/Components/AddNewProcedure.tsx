export default function AddNewProcedure() {
  ...
  return (
    <div className="p-10 border-r border-gray-400">
      <div className="relative after:content-[''] after:w-[1px] after:h-[480px] after:bg-gray-400 after:absolute after:left-4 after:-z-10 after:top-0">
        {
          procedure.map((item, index) => {
            const {title,isActive,isDone} = item;
            return (
              <div key={title} className="flex gap-3 mb-8">
