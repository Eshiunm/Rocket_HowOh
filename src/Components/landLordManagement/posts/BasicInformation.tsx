  ...
  return (
    <form className="flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="add-new-input-block">
        <label htmlFor="houseTitle" className="text-sm">
          名稱
        </label>
        <input
          type="text"
      ...
      <div className="flex gap-6">
        <div className="add-new-input-block">
          <label htmlFor="houseLoate" className="text-sm">
            縣市
          </label>
          <select
            id="houseLoate"
            className="add-new-input"
            {...register("houseLoate", { required: true })}
          >
            {cities.map(({ city }) => {
              let isSelected;
              if (city === "高雄市") {
              ...
              return (
                <option value={city} key={city} selected={isSelected}>
                  {city}
                </option>
              );
            })}
        ...
        <div className="add-new-input-block">
          <label htmlFor="houseDistrict" className="text-sm">
            區域
          </label>
          <select
            id="houseDistrict"
            className="add-new-input"
            {...register("houseDistrict", { required: true })}
          >
            {cities
        ...
        <div className="add-new-input-block">
          <label htmlFor="houseStreet" className="text-sm">
            路街
          </label>
          <input
            type="text"
      ...
      <div className="flex gap-6">
        <div className="add-new-input-block after:content-['巷'] add-new-input-unit">
          <label htmlFor="houseLane" className="text-sm">
            巷
          </label>
          <input
            type="text"
        ...
        <div className="add-new-input-block after:content-['弄'] add-new-input-unit">
          <label htmlFor="houseAlley" className="text-sm">
            弄
          </label>
          <input
            type="text"
        ...
        <div className="add-new-input-block">
          <label htmlFor="houseFloor" className="text-sm">
            樓層
          </label>
          <input
            type="number"
            ...
            className="add-new-input"
            placeholder="23"
            {...register("houseFloor", { min: 1 })}
          />
        </div>
        <div className="add-new-input-block">
          <label htmlFor="houseTotalFloors" className="text-sm">
            總樓數
          </label>
          <input
            type="number"
            ...
            className="add-new-input"
            placeholder="23"
            {...register("houseTotalFloors", { min: 1 })}
          />
        </div>
      </div>
      <div className="flex gap-6">
        <div className="add-new-input-block">
          <label htmlFor="houseType" className="text-sm">
            類型
          </label>
          <select
            id="houseType"
        ...
        <div className="add-new-input-block after:content-['坪'] add-new-input-unit">
          <label htmlFor="houseArea" className="text-sm">
            承租坪數
          </label>
          <input
            type="number"
            ...
            className="add-new-input"
            placeholder="承租坪數"
            {...register("houseArea", { required: true, min: 1 })}
          />
        </div>
      </div>
      <div className="add-new-input-block">
        ...
        <div id="houseLayout" className="flex gap-6">
          <div className="w-full after:content-['房'] add-new-input-unit after:right-11">
            <select
              ...
              {...register("houseRoom", { required: true })}
            >
