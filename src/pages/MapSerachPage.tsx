          ...
          <div className="flex flex-col gap-y-3">
            ...
            <div className="whitespace-nowrap self-start flex items-center cursor-pointer mr-8">
              <input
                ...
                id="districtsNoLimit"
                disabled={
                  (districtState.noLimit as { disabled?: boolean }).disabled ===
                  undefined
                    ? true
                    : (districtState.noLimit as { disabled?: boolean }).disabled
                }
              ...
              />
              <label htmlFor="districtsNoLimit" className="pl-2 cursor-pointer">
          ...
          <div className="flex flex-col gap-y-3">
            ...
            <div className="whitespace-nowrap self-start flex items-center cursor-pointer mr-8">
              <input
                ...
                checked={
                  (houseTypeState.noLimit as { checked?: boolean }).checked ===
                  undefined
                    ? true
                    : (houseTypeState.noLimit as { checked?: boolean }).checked
                }
              ...
              />
              <label htmlFor="houseTypeNoLimit" className="pl-2 cursor-pointer">
                  ...
                  return (
                    ...
                    >
                      <input
                        ...
                        id={typeNumber}
                        checked={checked}
                        {...register(`houseTypeNumber_${typeNumber as string}`)}
                        onChange={handleHouseTypeState}
                      />
                      <label
                        htmlFor={typeNumber}
          ...
          <div className="flex flex-col gap-y-3">
            ...
            <div className="whitespace-nowrap self-start flex items-center cursor-pointer mr-8">
              <input
                ...
                checked={
                  (rentRangeState.noLimit as { checked?: boolean }).checked ===
                  undefined
                    ? true
                    : (rentRangeState.noLimit as { checked?: boolean }).checked
                }
          ...
          <div className="flex flex-col gap-y-3">
            ...
            <div className="whitespace-nowrap self-start flex items-center cursor-pointer mr-8">
              ...
              <label
                ...
                className="pl-2 cursor-pointer"
              >
                {(houseFeaturesState.noLimit as { content?: string }).content}
              </label>
            </div>
            <div className="flex gap-x-[22px] gap-y-3 flex-wrap ">
                  ...
                  return (
                    ...
                    >
                      <input
                        ...
                        onChange={handleHouseFeaturesState}
                      />
                      <label htmlFor={type} className="pl-2 cursor-pointer">
                        {content}
                      </label>
                    </div>
                  );
          ...
          <div className="flex flex-col gap-y-3">
            ...
            <div className="whitespace-nowrap self-start flex items-center cursor-pointer mr-8">
              ...
              <label
                ...
                className="pl-2 cursor-pointer"
              >
                {(landLordRatingState.noLimit as { content?: string }).content}
              </label>
            </div>
            <div className="flex gap-x-[22px] gap-y-3 flex-wrap ">
