  ...
  useEffect(() => {
    const fetchHouseData = async () => {
      try {
        ...
        const photos = [coverPhoto, ...otherPhoto];
        setHouseDatas({
    ...
    <>
      <Flowbite theme={{ theme: customTheme }}>
        <Drawer
          ...
          open={isRentedOpen}
          onClose={() => handleRentedCanvas(false)}
          position="right"
        >
          <Drawer.Items>
            <div className="layout-grid mb-32">
              <div className="col-span-10 flex flex-col gap-6">
                ...
                <h3 className="text-sans-h5 mb-4">更改：已承租</h3>
                <p className="mb-2 text-sans-body1">
                  請填入承租資訊及合約起迄時間。
                </p>
                <form>
                  <div className="mb-5">
                  ...
                  <div className="mb-6 flex gap-6 items-center">
                    <div className="flex-1 relative">
                      <label
                        htmlFor="startTime"
                        className="text-sans-caption px-0.5 bg-Neutral-99 absolute -top-2 left-3"
                      >
                        合約起始日
                      </label>
                      <input
                        ...
                        name="startTime"
                        id="startTime"
                        className="w-full p-3 rounded border-black focus:ring-0 focus:border-Brand-30 bg-Neutral-99"
                      />
                    </div>
                    至
                    <div className="flex-1 relative">
      ...
      <header className="bg-Landlord-99">
        <div className="container py-6">
          ...
          <h2 className="text-sans-b-h5 mt-3 mb-6">
            {houseDatas.formData.name}
          </h2>
          <div className="flex justify-between items-end">
            ...
            <div className="flex gap-6">
              ...
              <button type="button" className="outline-button-m">
                查看合約
              </button>
              <Tooltip
              ...
              >
                <button
                  ...
                  onClick={() =>
                    navigate(`/landlord/publish/${houseId}/request`)
                  }
      ...
      <ForcedChangeModal
        openForceChangeModal={openForceChangeModal}
        setOpenForceChangeModal={setOpenForceChangeModal}
      />
